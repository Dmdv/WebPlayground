var Color = function() {
    ...
    }, e.hasNamedColor = function(r) {
        var o = ("" + r).toLowerCase();
        return e.namedColors.hasOwnProperty(o);
    }, e;
}();
...
var ColorRandomizer = function() {
    function e() {
        this.time = 1e3, this.textId = "about", this.colors = "red,yellow;blue;red,lightseagreen";
    }
    return e.prototype.Start = function() {
        this.PaintText();
    }, e.prototype.RandomColor = function() {
        for (var e = this.colors.split(/[\s,;]+/), r = e[Math.floor(Math.random() * e.length)], o = new Color(r); !o.ok; ) {
            console.log("Invalid, removing: " + o.value);
            var F = e.indexOf(r, 0);
            F > -1 && e.splice(F, 1), r = e[Math.floor(Math.random() * e.length)], o = new Color(r);
        }
        return o.value;
